...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Climb of Death is a create-your-own-adventure full-stack application created using the MVC design principle. It uses a SQL database to store and connect scenarios, and Handlebars.js to display those scenarios sequentially in response to user interaction.",
    stack: ["MVC", "SQL", "Handlebars.js", "Express.js", "Bulma"],
    github: "https://github.com/RichardZhang01/netflix-clone",
  ...
  },
  {
    title: "Text-Editor",
    description:
      "Just Another Text Editor. It's also a single-page application that meets the PWA criteria. This app features data persistence techniques that serve as redundancy, is downloadable, and additionally functions offline.",
  ...
  },
  {
    ...
    description:
      "This is a simple application that uses the OpenWeather API to allow users to search for weather data from most cities around the world. This is a front-end application, and was developed after 3 weeks of learning to code. It's also the first application that I was proud of.",
